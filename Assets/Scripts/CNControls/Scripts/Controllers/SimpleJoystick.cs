...
namespace CnControls
{
...
#endif
    {
        ...
        private void Awake()
        {
            ...
            coll.size = new Vector2(rt.rect.width + rt.rect.width / 5, rt.rect.height + rt.rect.height / 5);
            // coll.size = new Vector2(Screen.width / 2, Screen.height);
            coll.offset = coll.size / 2;
